...
const questions = [
  ...
  },
  {
    ...
    type: 'EI',
    weight: 22,
    question: '오랜만에 아주 마음에 드는 옷을 새로 샀을 때 나의 반응은?',
    optA: '당장 내일이라도 입고 나가 사람들에게 자랑하거나 보여주고 싶다.',
    optB: '거울 앞에서 조용히 몇 번 입어보며 혼자 만족해한다.'
  },
  {
    id: 5,
    type: 'EI',
    weight: 18,
    question: '친한 친구와 오해가 생겨 마음이 답답하고 스트레스받을 때 나는?',
    optA: '친구에게 바로 전화를 하거나 만나서 대화로 오해를 풀고 싶어 한다.',
    optB: '혼자 차분히 생각할 시간을 갖고 내 감정이 정리된 후 소통하고 싶다.'
  },
  ...
  },
  {
    ...
    type: 'SN',
    weight: 22,
    question: '만약 내가 우주선에 탑승해 새로운 행성으로 떠나는 가상 현실 상상을 할 때?',
    optA: '우주선 내의 산소/식량 관리 등 지극히 현실적인 생존 방안이 먼저 떠오른다.',
    optB: '미지의 우주 환경이 선사할 아름다움과 외계 문명과의 조우 등 낭만적 탐험을 상상한다.'
  },
  {
    id: 10,
    type: 'SN',
    weight: 18,
    question: '주변 친구가 나에게 요리 레시피를 물어볼 때 요령을 알려주는 스타일은?',
    optA: '“소금 5g, 물 300ml 넣고 정확히 5분 끓여”처럼 구체적인 계량을 짚어준다.',
    optB: '“간간해질 때까지 조미료를 적당히 넣고 맛보면서 맞춰”처럼 감각적으로 설명한다.'
  },
